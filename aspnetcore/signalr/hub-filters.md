...
---
# <a name="use-hub-filters-in-aspnet-core-no-locsignalr"></a><span data-ttu-id="ecb18-103">Utiliser des filtres de Hub dans ASP.NET Core :::no-loc(SignalR):::</span><span class="sxs-lookup"><span data-stu-id="ecb18-103">Use hub filters in ASP.NET Core :::no-loc(SignalR):::</span></span>
