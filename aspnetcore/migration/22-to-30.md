...
<details>
    ...
    <ul>
        ...
        <li><span data-ttu-id="74d79-141">Microsoft. AspNetCore. Authentication. Cookie x</span><span class="sxs-lookup"><span data-stu-id="74d79-141">Microsoft.AspNetCore.Authentication.Cookies</span></span></li>
        ...
        <li><span data-ttu-id="74d79-145">Microsoft. AspNetCore. Cookie Renvoi</span><span class="sxs-lookup"><span data-stu-id="74d79-145">Microsoft.AspNetCore.CookiePolicy</span></span></li>
        ...
        <li><span data-ttu-id="74d79-159">Microsoft. AspNetCore.Identity</span><span class="sxs-lookup"><span data-stu-id="74d79-159">Microsoft.AspNetCore.Identity</span></span></li>
        ...
        <li><span data-ttu-id="74d79-173">Microsoft. AspNetCore. Mvc.Razor</span><span class="sxs-lookup"><span data-stu-id="74d79-173">Microsoft.AspNetCore.Mvc.Razor</span></span></li>
        <li><span data-ttu-id="74d79-174">Microsoft. AspNetCore. Mvc. Razor . ViewCompilation</span><span class="sxs-lookup"><span data-stu-id="74d79-174">Microsoft.AspNetCore.Mvc.Razor.ViewCompilation</span></span></li>
        <li><span data-ttu-id="74d79-175">Microsoft. AspNetCore. Mvc. Razor Pages</span><span class="sxs-lookup"><span data-stu-id="74d79-175">Microsoft.AspNetCore.Mvc.RazorPages</span></span></li>
        ...
        <li><span data-ttu-id="74d79-178">Microsoft. AspNetCore.Razor</span><span class="sxs-lookup"><span data-stu-id="74d79-178">Microsoft.AspNetCore.Razor</span></span></li>
        <li><span data-ttu-id="74d79-179">Microsoft. AspNetCore. Razor . Language</span><span class="sxs-lookup"><span data-stu-id="74d79-179">Microsoft.AspNetCore.Razor.Runtime</span></span></li>
        <li><span data-ttu-id="74d79-180">Microsoft. AspNetCore. Razor . Nomination</span><span class="sxs-lookup"><span data-stu-id="74d79-180">Microsoft.AspNetCore.Razor.Design</span></span></li>
        ...
        <li><span data-ttu-id="74d79-196">Microsoft. AspNetCore.SignalR</span><span class="sxs-lookup"><span data-stu-id="74d79-196">Microsoft.AspNetCore.SignalR</span></span></li>
        <li><span data-ttu-id="74d79-197">Microsoft. AspNetCore. SignalR . Ebauche</span><span class="sxs-lookup"><span data-stu-id="74d79-197">Microsoft.AspNetCore.SignalR.Core</span></span></li>
...
### <a name="use-newtonsoftjson-in-an-aspnet-core-30-no-locsignalr-project"></a><span data-ttu-id="74d79-340">Utilisez Newtonsoft.Jssur dans un projet ASP.NET Core 3,0 SignalR</span><span class="sxs-lookup"><span data-stu-id="74d79-340">Use Newtonsoft.Json in an ASP.NET Core 3.0 SignalR project</span></span>
...
<span data-ttu-id="74d79-443">Le mappage des SignalR hubs a désormais lieu à l’intérieur de `UseEndpoints` .</span><span class="sxs-lookup"><span data-stu-id="74d79-443">Mapping of SignalR hubs now takes place inside `UseEndpoints`.</span></span>
...
<span data-ttu-id="74d79-446">Dans l’exemple suivant, la prise en charge du `ChatHub` SignalR Hub est ajoutée :</span><span class="sxs-lookup"><span data-stu-id="74d79-446">In the following example, support for the `ChatHub` SignalR hub is added:</span></span>
...
### <a name="no-locrazor-pages"></a><span data-ttu-id="74d79-488">Razor Pages</span><span class="sxs-lookup"><span data-stu-id="74d79-488">Razor Pages</span></span>

<span data-ttu-id="74d79-489">Les pages de mappage ont Razor maintenant lieu dans `UseEndpoints` .</span><span class="sxs-lookup"><span data-stu-id="74d79-489">Mapping Razor Pages now takes place inside `UseEndpoints`.</span></span>

<span data-ttu-id="74d79-490">Ajoutez `MapRazorPages` si l’application utilise des Razor pages.</span><span class="sxs-lookup"><span data-stu-id="74d79-490">Add `MapRazorPages` if the app uses Razor Pages.</span></span> <span data-ttu-id="74d79-491">Dans la mesure où le routage des points de terminaison inclut la prise en charge de nombreuses infrastructures, l’ajout de Razor pages est maintenant en cours d’abonnement.</span><span class="sxs-lookup"><span data-stu-id="74d79-491">Since Endpoint Routing includes support for many frameworks, adding Razor Pages is now opt-in.</span></span>

<span data-ttu-id="74d79-492">Dans la `Startup.Configure` méthode suivante, `MapRazorPages` ajoute la prise en charge des Razor pages :</span><span class="sxs-lookup"><span data-stu-id="74d79-492">In the following `Startup.Configure` method, `MapRazorPages` adds support for Razor Pages:</span></span>
...
## <a name="no-locidentity-ui"></a><span data-ttu-id="74d79-527">Interface utilisateur du service Identity</span><span class="sxs-lookup"><span data-stu-id="74d79-527">Identity UI</span></span>

<span data-ttu-id="74d79-528">Identity Mises à jour de l’interface utilisateur pour ASP.NET Core 3,0 :</span><span class="sxs-lookup"><span data-stu-id="74d79-528">Identity UI updates for ASP.NET Core 3.0:</span></span>

* <span data-ttu-id="74d79-529">Ajoutez une référence de package à [Microsoft. AspNetCore. Identity Interface utilisateur](https://nuget.org/packages/Microsoft.AspNetCore.Identity.UI).</span><span class="sxs-lookup"><span data-stu-id="74d79-529">Add a package reference to [Microsoft.AspNetCore.Identity.UI](https://nuget.org/packages/Microsoft.AspNetCore.Identity.UI).</span></span>
* <span data-ttu-id="74d79-530">Les applications qui n’utilisent pas de Razor pages doivent appeler `MapRazorPages` .</span><span class="sxs-lookup"><span data-stu-id="74d79-530">Apps that don't use Razor Pages must call `MapRazorPages`.</span></span> <span data-ttu-id="74d79-531">Consultez les [ Razor pages](#razor-pages) de ce document.</span><span class="sxs-lookup"><span data-stu-id="74d79-531">See [Razor Pages](#razor-pages) in this document.</span></span>
* <span data-ttu-id="74d79-532">Bootstrap 4 est l’infrastructure d’interface utilisateur par défaut.</span><span class="sxs-lookup"><span data-stu-id="74d79-532">Bootstrap 4 is the default UI framework.</span></span> <span data-ttu-id="74d79-533">Définissez une `IdentityUIFrameworkVersion` propriété de projet pour modifier la valeur par défaut.</span><span class="sxs-lookup"><span data-stu-id="74d79-533">Set an `IdentityUIFrameworkVersion` project property to change the default.</span></span> <span data-ttu-id="74d79-534">Pour plus d’informations, consultez [cette annonce GitHub](https://github.com/aspnet/Announcements/issues/380).</span><span class="sxs-lookup"><span data-stu-id="74d79-534">For more information, see [this GitHub announcement](https://github.com/aspnet/Announcements/issues/380).</span></span>

## SignalR

<span data-ttu-id="74d79-535">Le SignalR client JavaScript est passé de `@aspnet/signalr` à `@microsoft/signalr` .</span><span class="sxs-lookup"><span data-stu-id="74d79-535">The SignalR JavaScript client has changed from `@aspnet/signalr` to `@microsoft/signalr`.</span></span> <span data-ttu-id="74d79-536">Pour réagir à cette modification, modifiez les références dans *package.jssur* les fichiers, `require` les instructions et les `import` instructions ECMAScript.</span><span class="sxs-lookup"><span data-stu-id="74d79-536">To react to this change, change the references in *package.json* files, `require` statements, and ECMAScript `import` statements.</span></span>
...
1. <span data-ttu-id="74d79-559">Installez [Microsoft. AspNetCore. Mvc. Razor . ](https://www.nuget.org/packages/Microsoft.AspNetCore.Mvc.Razor.RuntimeCompilation) Package NuGet RuntimeCompilation.</span><span class="sxs-lookup"><span data-stu-id="74d79-559">Install the [Microsoft.AspNetCore.Mvc.Razor.RuntimeCompilation](https://www.nuget.org/packages/Microsoft.AspNetCore.Mvc.Razor.RuntimeCompilation) NuGet package.</span></span>
1. <span data-ttu-id="74d79-560">Mise à jour `Startup.ConfigureServices` pour appeler `AddRazorRuntimeCompilation` :</span><span class="sxs-lookup"><span data-stu-id="74d79-560">Update `Startup.ConfigureServices` to call `AddRazorRuntimeCompilation`:</span></span>
    ...
    <span data-ttu-id="74d79-562">Pour ASP.NET Core Razor pages, utilisez le code suivant :</span><span class="sxs-lookup"><span data-stu-id="74d79-562">For ASP.NET Core Razor Pages, use the following code:</span></span>
...
<span data-ttu-id="74d79-564">Pour plus d’informations sur la Razor compilation de fichiers, consultez <xref:mvc/views/view-compilation> .</span><span class="sxs-lookup"><span data-stu-id="74d79-564">For more information on Razor file compilation, see <xref:mvc/views/view-compilation>.</span></span>
