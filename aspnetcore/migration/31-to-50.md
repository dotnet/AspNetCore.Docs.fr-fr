...
>
> La possibilité de définir l’option sur `false` ou de la conserver non définie, qui a comme valeur par défaut l’option `false` , *est fournie uniquement pour la compatibilité descendante*.
>
...
Dans le panneau Portail Azure l’authentification de l’inscription de l' *`Client`* application : **Authentication**
