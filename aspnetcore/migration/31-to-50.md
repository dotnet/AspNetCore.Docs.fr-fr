...
>
> La possibilité de définir la valeur ou de la `PreferExactMatches` `@false` conserver comme étant non définie, qui a comme valeur par défaut l’option `false` en C#, *est fournie uniquement pour la compatibilité descendante*.
>
