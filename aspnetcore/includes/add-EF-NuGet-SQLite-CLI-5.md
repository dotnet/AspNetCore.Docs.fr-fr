<span data-ttu-id="87d07-101">Exécutez les commandes CLI .NET suivantes :</span><span class="sxs-lookup"><span data-stu-id="87d07-101">Run the following .NET CLI commands:</span></span>
