<span data-ttu-id="2bb41-101">Exécutez les commandes CLI .NET Core suivantes :</span><span class="sxs-lookup"><span data-stu-id="2bb41-101">Run the following .NET Core CLI commands:</span></span>
