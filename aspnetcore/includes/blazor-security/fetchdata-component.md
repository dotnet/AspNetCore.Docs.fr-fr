<span data-ttu-id="92543-101">Le `FetchData` composant montre comment :</span><span class="sxs-lookup"><span data-stu-id="92543-101">The `FetchData` component shows how to:</span></span>
