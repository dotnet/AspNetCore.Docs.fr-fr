# <a name="blazor-server-sample-app"></a><span data-ttu-id="bda65-101">Exemple d’application de serveur éblouissant</span><span class="sxs-lookup"><span data-stu-id="bda65-101">Blazor Server Sample App</span></span>
