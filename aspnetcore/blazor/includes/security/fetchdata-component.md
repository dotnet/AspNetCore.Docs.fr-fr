<span data-ttu-id="29480-101">Le `FetchData` composant montre comment :</span><span class="sxs-lookup"><span data-stu-id="29480-101">The `FetchData` component shows how to:</span></span>
