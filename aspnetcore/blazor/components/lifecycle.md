...
---
# <a name="aspnet-core-no-locblazor-lifecycle"></a><span data-ttu-id="5ed8d-103">BlazorCycle de vie ASP.net Core</span><span class="sxs-lookup"><span data-stu-id="5ed8d-103">ASP.NET Core Blazor lifecycle</span></span>
...
<span data-ttu-id="5ed8d-147">Blazor Server applications qui [préaffichent le contenu](xref:blazor/fundamentals/additional-scenarios#render-mode) de l’appel à <xref:Microsoft.AspNetCore.Components.ComponentBase.OnInitializedAsync%2A> *deux reprises* :</span><span class="sxs-lookup"><span data-stu-id="5ed8d-147">Blazor Server apps that [prerender their content](xref:blazor/fundamentals/additional-scenarios#render-mode) call <xref:Microsoft.AspNetCore.Components.ComponentBase.OnInitializedAsync%2A> *twice* :</span></span>
...
<span data-ttu-id="5ed8d-215">Pour éviter le double-rendu du scénario dans une Blazor Server application :</span><span class="sxs-lookup"><span data-stu-id="5ed8d-215">To avoid the double-rendering scenario in a Blazor Server app:</span></span>
...
<span data-ttu-id="5ed8d-219">Le code suivant illustre une mise à jour `WeatherForecastService` dans une application basée sur un modèle Blazor Server qui évite le double rendu :</span><span class="sxs-lookup"><span data-stu-id="5ed8d-219">The following code demonstrates an updated `WeatherForecastService` in a template-based Blazor Server app that avoids the double rendering:</span></span>
