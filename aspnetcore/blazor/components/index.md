...
## <a name="component-classes"></a><span data-ttu-id="8aff3-110">Classes de composant</span><span class="sxs-lookup"><span data-stu-id="8aff3-110">Component classes</span></span>
...
### <a name="routing"></a><span data-ttu-id="8aff3-122">Routage</span><span class="sxs-lookup"><span data-stu-id="8aff3-122">Routing</span></span>
...
* <span data-ttu-id="8aff3-149">L' `Counter` espace de noms du composant est `BlazorSample.Pages` .</span><span class="sxs-lookup"><span data-stu-id="8aff3-149">The `Counter` component's namespace is `BlazorSample.Pages`.</span></span>
...
<span data-ttu-id="8aff3-191">Le balisage suivant dans `Pages/Index.razor` rend une `HeadingComponent` instance de :</span><span class="sxs-lookup"><span data-stu-id="8aff3-191">The following markup in `Pages/Index.razor` renders a `HeadingComponent` instance:</span></span>
...
<span data-ttu-id="8aff3-202">`Pages/RouteParameter.razor`:</span><span class="sxs-lookup"><span data-stu-id="8aff3-202">`Pages/RouteParameter.razor`:</span></span>
...
* <span data-ttu-id="8aff3-216">Pour assigner le champ, la propriété ou la méthode d’un composant parent au paramètre d’un composant enfant, préfixez le nom du champ, de la propriété ou de la méthode avec le `@` symbole.</span><span class="sxs-lookup"><span data-stu-id="8aff3-216">To assign a parent component's field, property, or method to a child component's parameter, prefix the field, property, or method name with the `@` symbol.</span></span> <span data-ttu-id="8aff3-217">Pour assigner le résultat d’une [expression C# implicite](xref:mvc/views/razor#implicit-razor-expressions) à un paramètre, préfixez l’expression implicite avec un `@` symbole.</span><span class="sxs-lookup"><span data-stu-id="8aff3-217">To assign the result of an [implicit C# expression](xref:mvc/views/razor#implicit-razor-expressions) to a parameter, prefix the implicit expression with an `@` symbol.</span></span>
  ...
  * <span data-ttu-id="8aff3-219">Valeur du `title` champ.</span><span class="sxs-lookup"><span data-stu-id="8aff3-219">The value of the `title` field.</span></span>
...
* <span data-ttu-id="8aff3-234">Pour assigner le résultat d’une [expression C# explicite](xref:mvc/views/razor#explicit-razor-expressions) dans le composant parent au paramètre d’un composant enfant, placez l’expression entre parenthèses avec un `@` préfixe de symbole.</span><span class="sxs-lookup"><span data-stu-id="8aff3-234">To assign the result of an [explicit C# expression](xref:mvc/views/razor#explicit-razor-expressions) in the parent component to a child component's parameter, surround the expression in parentheses with an `@` symbol prefix.</span></span>
  ...
  > <span data-ttu-id="8aff3-243">Les attributs de composant ne prennent pas en charge le contenu complexe (mixte C# et balisage).</span><span class="sxs-lookup"><span data-stu-id="8aff3-243">Component attributes do not support complex content (mixed C# and markup).</span></span>
...
<span data-ttu-id="8aff3-264">`Shared/ChildComponent.razor`:</span><span class="sxs-lookup"><span data-stu-id="8aff3-264">`Shared/ChildComponent.razor`:</span></span>
...
* <span data-ttu-id="8aff3-298">Ajoutez un [`@ref`][4] attribut au composant enfant.</span><span class="sxs-lookup"><span data-stu-id="8aff3-298">Add an [`@ref`][4] attribute to the child component.</span></span>
...
### <a name="avoid-thread-blocking-calls"></a><span data-ttu-id="8aff3-320">Éviter les appels de blocage de thread</span><span class="sxs-lookup"><span data-stu-id="8aff3-320">Avoid thread-blocking calls</span></span>
...
* <span data-ttu-id="8aff3-327">Dans Blazor WebAssembly , inscrivez le service comme Singleton dans `Program.Main` :</span><span class="sxs-lookup"><span data-stu-id="8aff3-327">In Blazor WebAssembly, register the service as singleton in `Program.Main`:</span></span>
...
### <a name="when-to-use-key"></a><span data-ttu-id="8aff3-355">Quand utiliser la \@ clé</span><span class="sxs-lookup"><span data-stu-id="8aff3-355">When to use \@key</span></span>
...
### <a name="what-values-to-use-for-key"></a><span data-ttu-id="8aff3-365">Valeurs à utiliser pour la \@ clé</span><span class="sxs-lookup"><span data-stu-id="8aff3-365">What values to use for \@key</span></span>
...
* <span data-ttu-id="8aff3-380">Le composant enfant est restitué avec une ou plusieurs valeurs de paramètre à partir du composant parent.</span><span class="sxs-lookup"><span data-stu-id="8aff3-380">The child component is rendered with one or more parameter values from the parent component.</span></span>
...
<span data-ttu-id="8aff3-384">**Nos conseils généraux ne permettent pas de créer des composants qui écrivent directement dans leurs propres paramètres.**</span><span class="sxs-lookup"><span data-stu-id="8aff3-384">**Our general guidance is not to create components that directly write to their own parameters.**</span></span>

<span data-ttu-id="8aff3-385">Prenons l’exemple du composant défaillant suivant `Expander` :</span><span class="sxs-lookup"><span data-stu-id="8aff3-385">Consider the following faulty `Expander` component that:</span></span>

* <span data-ttu-id="8aff3-386">Restitue le contenu enfant.</span><span class="sxs-lookup"><span data-stu-id="8aff3-386">Renders child content.</span></span>
* <span data-ttu-id="8aff3-387">Active ou désactive l’indication du contenu enfant avec un paramètre de composant ( `Expanded` ).</span><span class="sxs-lookup"><span data-stu-id="8aff3-387">Toggles showing child content with a component parameter (`Expanded`).</span></span>
* <span data-ttu-id="8aff3-388">Le composant écrit directement dans le `Expanded` paramètre, qui illustre le problème avec les paramètres remplacés et doit être évité.</span><span class="sxs-lookup"><span data-stu-id="8aff3-388">The component writes directly to the `Expanded` parameter, which demonstrates the problem with overwritten parameters and should be avoided.</span></span>
...
<span data-ttu-id="8aff3-389">Le `Expander` composant est ajouté à un composant parent qui peut appeler <xref:Microsoft.AspNetCore.Components.ComponentBase.StateHasChanged%2A> :</span><span class="sxs-lookup"><span data-stu-id="8aff3-389">The `Expander` component is added to a parent component that may call <xref:Microsoft.AspNetCore.Components.ComponentBase.StateHasChanged%2A>:</span></span>
...
<span data-ttu-id="8aff3-390">Au départ, les `Expander` composants se comportent indépendamment lorsque leurs `Expanded` propriétés sont basculées.</span><span class="sxs-lookup"><span data-stu-id="8aff3-390">Initially, the `Expander` components behave independently when their `Expanded` properties are toggled.</span></span> <span data-ttu-id="8aff3-391">Les composants enfants maintiennent leurs États comme prévu.</span><span class="sxs-lookup"><span data-stu-id="8aff3-391">The child components maintain their states as expected.</span></span> <span data-ttu-id="8aff3-392">Lorsque <xref:Microsoft.AspNetCore.Components.ComponentBase.StateHasChanged%2A> est appelé dans le parent, le `Expanded` paramètre du premier composant enfant est réinitialisé à sa valeur initiale ( `true` ).</span><span class="sxs-lookup"><span data-stu-id="8aff3-392">When <xref:Microsoft.AspNetCore.Components.ComponentBase.StateHasChanged%2A> is called in the parent, the `Expanded` parameter of the first child component is reset back to its initial value (`true`).</span></span> <span data-ttu-id="8aff3-393">La `Expander` valeur du deuxième composant `Expanded` n’est pas réinitialisée, car aucun contenu enfant n’est restitué dans le deuxième composant.</span><span class="sxs-lookup"><span data-stu-id="8aff3-393">The second `Expander` component's `Expanded` value isn't reset because no child content is rendered in the second component.</span></span>

<span data-ttu-id="8aff3-394">Pour maintenir l’État dans le scénario précédent, utilisez un *champ privé* dans le `Expander` composant pour maintenir son état bascule.</span><span class="sxs-lookup"><span data-stu-id="8aff3-394">To maintain state in the preceding scenario, use a *private field* in the `Expander` component to maintain its toggled state.</span></span>

<span data-ttu-id="8aff3-395">Le composant révisé suivant `Expander` :</span><span class="sxs-lookup"><span data-stu-id="8aff3-395">The following revised `Expander` component:</span></span>

* <span data-ttu-id="8aff3-396">Accepte la `Expanded` valeur de paramètre du composant à partir du parent.</span><span class="sxs-lookup"><span data-stu-id="8aff3-396">Accepts the `Expanded` component parameter value from the parent.</span></span>
* <span data-ttu-id="8aff3-397">Affecte la valeur du paramètre de composant à un *champ privé* ( `expanded` ) dans l' [événement OnInitialized](xref:blazor/components/lifecycle#component-initialization-methods).</span><span class="sxs-lookup"><span data-stu-id="8aff3-397">Assigns the component parameter value to a *private field* (`expanded`) in the [OnInitialized event](xref:blazor/components/lifecycle#component-initialization-methods).</span></span>
* <span data-ttu-id="8aff3-398">Utilise le champ privé pour conserver son état bascule interne, qui montre comment éviter d’écrire directement dans un paramètre.</span><span class="sxs-lookup"><span data-stu-id="8aff3-398">Uses the private field to maintain its internal toggle state, which demonstrates how to avoid writing directly to a parameter.</span></span>
...
<span data-ttu-id="8aff3-399">Pour plus d’informations, consultez [ Blazor erreur de liaison bidirectionnelle (dotnet/aspnetcore #24599)](https://github.com/dotnet/aspnetcore/issues/24599).</span><span class="sxs-lookup"><span data-stu-id="8aff3-399">For additional information, see [Blazor Two Way Binding Error (dotnet/aspnetcore #24599)](https://github.com/dotnet/aspnetcore/issues/24599).</span></span> 

## <a name="apply-an-attribute"></a><span data-ttu-id="8aff3-400">Appliquer un attribut</span><span class="sxs-lookup"><span data-stu-id="8aff3-400">Apply an attribute</span></span>

<span data-ttu-id="8aff3-401">Les attributs peuvent être appliqués aux Razor composants avec la [`@attribute`][7] directive.</span><span class="sxs-lookup"><span data-stu-id="8aff3-401">Attributes can be applied to Razor components with the [`@attribute`][7] directive.</span></span> <span data-ttu-id="8aff3-402">L’exemple suivant applique l' [ `[Authorize]` attribut](xref:Microsoft.AspNetCore.Authorization.AuthorizeAttribute) à la classe de composant :</span><span class="sxs-lookup"><span data-stu-id="8aff3-402">The following example applies the [`[Authorize]` attribute](xref:Microsoft.AspNetCore.Authorization.AuthorizeAttribute) to the component class:</span></span>
...
## <a name="conditional-html-element-attributes"></a><span data-ttu-id="8aff3-403">Attributs d’éléments HTML conditionnels</span><span class="sxs-lookup"><span data-stu-id="8aff3-403">Conditional HTML element attributes</span></span>

<span data-ttu-id="8aff3-404">Les attributs des éléments HTML sont rendus de manière conditionnelle en fonction de la valeur .NET.</span><span class="sxs-lookup"><span data-stu-id="8aff3-404">HTML element attributes are conditionally rendered based on the .NET value.</span></span> <span data-ttu-id="8aff3-405">Si la valeur est `false` ou `null` , l’attribut n’est pas rendu.</span><span class="sxs-lookup"><span data-stu-id="8aff3-405">If the value is `false` or `null`, the attribute isn't rendered.</span></span> <span data-ttu-id="8aff3-406">Si la valeur est `true` , l’attribut est rendu réduit.</span><span class="sxs-lookup"><span data-stu-id="8aff3-406">If the value is `true`, the attribute is rendered minimized.</span></span>

<span data-ttu-id="8aff3-407">Dans l’exemple suivant, `IsCompleted` détermine si `checked` est rendu dans le balisage de l’élément :</span><span class="sxs-lookup"><span data-stu-id="8aff3-407">In the following example, `IsCompleted` determines if `checked` is rendered in the element's markup:</span></span>
...
<span data-ttu-id="8aff3-408">Si `IsCompleted` est `true` , la case à cocher s’affiche comme suit :</span><span class="sxs-lookup"><span data-stu-id="8aff3-408">If `IsCompleted` is `true`, the check box is rendered as:</span></span>

```html
<input type="checkbox" checked />
```

<span data-ttu-id="8aff3-409">Si `IsCompleted` est `false` , la case à cocher s’affiche comme suit :</span><span class="sxs-lookup"><span data-stu-id="8aff3-409">If `IsCompleted` is `false`, the check box is rendered as:</span></span>

```html
<input type="checkbox" />
```

<span data-ttu-id="8aff3-410">Pour plus d’informations, consultez informations [ Razor de référence sur la syntaxe pour ASP.net Core](xref:mvc/views/razor).</span><span class="sxs-lookup"><span data-stu-id="8aff3-410">For more information, see [Razor syntax reference for ASP.NET Core](xref:mvc/views/razor).</span></span>

> [!WARNING]
> <span data-ttu-id="8aff3-411">Certains attributs HTML, tels que [`aria-pressed`](https://developer.mozilla.org/docs/Web/Accessibility/ARIA/Roles/button_role#Toggle_buttons) , ne fonctionnent pas correctement quand le type .net est un `bool` .</span><span class="sxs-lookup"><span data-stu-id="8aff3-411">Some HTML attributes, such as [`aria-pressed`](https://developer.mozilla.org/docs/Web/Accessibility/ARIA/Roles/button_role#Toggle_buttons), don't function properly when the .NET type is a `bool`.</span></span> <span data-ttu-id="8aff3-412">Dans ce cas, utilisez un `string` type au lieu d’un `bool` .</span><span class="sxs-lookup"><span data-stu-id="8aff3-412">In those cases, use a `string` type instead of a `bool`.</span></span>

## <a name="raw-html"></a><span data-ttu-id="8aff3-413">HTML brut</span><span class="sxs-lookup"><span data-stu-id="8aff3-413">Raw HTML</span></span>

<span data-ttu-id="8aff3-414">Les chaînes sont normalement rendues à l’aide de nœuds de texte DOM, ce qui signifie que tout balisage qu’elles peuvent contenir est ignorée et traitée comme du texte littéral.</span><span class="sxs-lookup"><span data-stu-id="8aff3-414">Strings are normally rendered using DOM text nodes, which means that any markup they may contain is ignored and treated as literal text.</span></span> <span data-ttu-id="8aff3-415">Pour afficher le code HTML brut, encapsulez le contenu HTML dans une `MarkupString` valeur.</span><span class="sxs-lookup"><span data-stu-id="8aff3-415">To render raw HTML, wrap the HTML content in a `MarkupString` value.</span></span> <span data-ttu-id="8aff3-416">La valeur est analysée au format HTML ou SVG et est insérée dans le DOM.</span><span class="sxs-lookup"><span data-stu-id="8aff3-416">The value is parsed as HTML or SVG and inserted into the DOM.</span></span>

> [!WARNING]
> <span data-ttu-id="8aff3-417">Le rendu de code HTML brut construit à partir de n’importe quelle source non approuvée constitue un risque pour la **sécurité** et doit être évité !</span><span class="sxs-lookup"><span data-stu-id="8aff3-417">Rendering raw HTML constructed from any untrusted source is a **security risk** and should be avoided!</span></span>

<span data-ttu-id="8aff3-418">L’exemple suivant illustre l’utilisation du `MarkupString` type pour ajouter un bloc de contenu HTML statique à la sortie rendue d’un composant :</span><span class="sxs-lookup"><span data-stu-id="8aff3-418">The following example shows using the `MarkupString` type to add a block of static HTML content to the rendered output of a component:</span></span>
...
## <a name="razor-templates"></a><span data-ttu-id="8aff3-419">Razor ceux</span><span class="sxs-lookup"><span data-stu-id="8aff3-419">Razor templates</span></span>

<span data-ttu-id="8aff3-420">Les fragments de rendu peuvent être définis à l’aide de la Razor syntaxe de modèle.</span><span class="sxs-lookup"><span data-stu-id="8aff3-420">Render fragments can be defined using Razor template syntax.</span></span> <span data-ttu-id="8aff3-421">Razor les modèles sont un moyen de définir un extrait de code d’interface utilisateur et de supposer le format suivant :</span><span class="sxs-lookup"><span data-stu-id="8aff3-421">Razor templates are a way to define a UI snippet and assume the following format:</span></span>

```razor
@<{HTML tag}>...</{HTML tag}>
```

<span data-ttu-id="8aff3-422">L’exemple suivant montre comment spécifier <xref:Microsoft.AspNetCore.Components.RenderFragment> des valeurs et <xref:Microsoft.AspNetCore.Components.RenderFragment%601> et restituer des modèles directement dans un composant.</span><span class="sxs-lookup"><span data-stu-id="8aff3-422">The following example illustrates how to specify <xref:Microsoft.AspNetCore.Components.RenderFragment> and <xref:Microsoft.AspNetCore.Components.RenderFragment%601> values and render templates directly in a component.</span></span> <span data-ttu-id="8aff3-423">Les fragments de rendu peuvent également être passés comme arguments à des [composants basés](xref:blazor/components/templated-components)sur un modèle.</span><span class="sxs-lookup"><span data-stu-id="8aff3-423">Render fragments can also be passed as arguments to [templated components](xref:blazor/components/templated-components).</span></span>
...
<span data-ttu-id="8aff3-424">Sortie rendue du code précédent :</span><span class="sxs-lookup"><span data-stu-id="8aff3-424">Rendered output of the preceding code:</span></span>
...
## <a name="static-assets"></a><span data-ttu-id="8aff3-425">Les ressources statiques</span><span class="sxs-lookup"><span data-stu-id="8aff3-425">Static assets</span></span>

<span data-ttu-id="8aff3-426">Blazorrespecte la Convention de ASP.NET Core les applications qui placent des ressources statiques dans le [ `web root (wwwroot)` dossier](xref:fundamentals/index#web-root)du projet.</span><span class="sxs-lookup"><span data-stu-id="8aff3-426">Blazor follows the convention of ASP.NET Core apps placing static assets under the project's [`web root (wwwroot)` folder](xref:fundamentals/index#web-root).</span></span>

<span data-ttu-id="8aff3-427">Utilisez un chemin d’accès relatif à `/` la base () pour faire référence à la racine Web d’une ressource statique.</span><span class="sxs-lookup"><span data-stu-id="8aff3-427">Use a base-relative path (`/`) to refer to the web root for a static asset.</span></span> <span data-ttu-id="8aff3-428">Dans l’exemple suivant, `logo.png` se trouve physiquement dans le `{PROJECT ROOT}/wwwroot/images` dossier :</span><span class="sxs-lookup"><span data-stu-id="8aff3-428">In the following example, `logo.png` is physically located in the `{PROJECT ROOT}/wwwroot/images` folder:</span></span>

```razor
<img alt="Company logo" src="/images/logo.png" />
```

<span data-ttu-id="8aff3-429">Razor les composants ne prennent **pas** en charge la notation tilde-slash ( `~/` ).</span><span class="sxs-lookup"><span data-stu-id="8aff3-429">Razor components do **not** support tilde-slash notation (`~/`).</span></span>

<span data-ttu-id="8aff3-430">Pour plus d’informations sur la définition du chemin d’accès de base d’une application, consultez <xref:blazor/host-and-deploy/index#app-base-path> .</span><span class="sxs-lookup"><span data-stu-id="8aff3-430">For information on setting an app's base path, see <xref:blazor/host-and-deploy/index#app-base-path>.</span></span>

## <a name="tag-helpers-arent-supported-in-components"></a><span data-ttu-id="8aff3-431">Les balises tag Helper ne sont pas prises en charge dans les composants</span><span class="sxs-lookup"><span data-stu-id="8aff3-431">Tag Helpers aren't supported in components</span></span>

<span data-ttu-id="8aff3-432">[`Tag Helpers`](xref:mvc/views/tag-helpers/intro) ne sont pas pris en charge dans les Razor composants ( `.razor` fichiers).</span><span class="sxs-lookup"><span data-stu-id="8aff3-432">[`Tag Helpers`](xref:mvc/views/tag-helpers/intro) aren't supported in Razor components (`.razor` files).</span></span> <span data-ttu-id="8aff3-433">Pour fournir des fonctionnalités semblables à tag Helper dans Blazor , créez un composant avec les mêmes fonctionnalités que le tag Helper et utilisez le composant à la place.</span><span class="sxs-lookup"><span data-stu-id="8aff3-433">To provide Tag Helper-like functionality in Blazor, create a component with the same functionality as the Tag Helper and use the component instead.</span></span>

## <a name="scalable-vector-graphics-svg-images"></a><span data-ttu-id="8aff3-434">Images SVG (Scalable Vector Graphics)</span><span class="sxs-lookup"><span data-stu-id="8aff3-434">Scalable Vector Graphics (SVG) images</span></span>

<span data-ttu-id="8aff3-435">Étant donné que Blazor le rendu des images HTML, prises en charge par le navigateur, y compris les images SVG (Scalable Vector Graphics) ( `.svg` ), est pris en charge via la `<img>` balise :</span><span class="sxs-lookup"><span data-stu-id="8aff3-435">Since Blazor renders HTML, browser-supported images, including Scalable Vector Graphics (SVG) images (`.svg`), are supported via the `<img>` tag:</span></span>

```html
<img alt="Example image" src="some-image.svg" />
```

<span data-ttu-id="8aff3-436">De même, les images SVG sont prises en charge dans les règles CSS d’un fichier de feuille de style ( `.css` ) :</span><span class="sxs-lookup"><span data-stu-id="8aff3-436">Similarly, SVG images are supported in the CSS rules of a stylesheet file (`.css`):</span></span>
...
<span data-ttu-id="8aff3-437">Toutefois, le balisage SVG en ligne n’est pas pris en charge dans tous les scénarios.</span><span class="sxs-lookup"><span data-stu-id="8aff3-437">However, inline SVG markup isn't supported in all scenarios.</span></span> <span data-ttu-id="8aff3-438">Si vous placez une `<svg>` balise directement dans un fichier de composant ( `.razor` ), le rendu d’image de base est pris en charge, mais de nombreux scénarios avancés ne sont pas encore pris en charge.</span><span class="sxs-lookup"><span data-stu-id="8aff3-438">If you place an `<svg>` tag directly into a component file (`.razor`), basic image rendering is supported but many advanced scenarios aren't yet supported.</span></span> <span data-ttu-id="8aff3-439">Par exemple, les `<use>` balises ne sont pas actuellement respectées et [`@bind`][10] ne peuvent pas être utilisées avec certaines balises SVG.</span><span class="sxs-lookup"><span data-stu-id="8aff3-439">For example, `<use>` tags aren't currently respected, and [`@bind`][10] can't be used with some SVG tags.</span></span> <span data-ttu-id="8aff3-440">Pour plus d’informations, consultez [prise en charge SVG dans Blazor (dotnet/aspnetcore #18271)](https://github.com/dotnet/aspnetcore/issues/18271).</span><span class="sxs-lookup"><span data-stu-id="8aff3-440">For more information, see [SVG support in Blazor (dotnet/aspnetcore #18271)](https://github.com/dotnet/aspnetcore/issues/18271).</span></span>

## <a name="whitespace-rendering-behavior"></a><span data-ttu-id="8aff3-441">Comportement de rendu des espaces blancs</span><span class="sxs-lookup"><span data-stu-id="8aff3-441">Whitespace rendering behavior</span></span>

::: moniker range=">= aspnetcore-5.0"

<span data-ttu-id="8aff3-442">Sauf [`@preservewhitespace`](xref:mvc/views/razor#preservewhitespace) si la directive est utilisée avec la valeur `true` , l’espace blanc supplémentaire est supprimé par défaut si :</span><span class="sxs-lookup"><span data-stu-id="8aff3-442">Unless the [`@preservewhitespace`](xref:mvc/views/razor#preservewhitespace) directive is used with a value of `true`, extra whitespace is removed by default if:</span></span>

* <span data-ttu-id="8aff3-443">À gauche ou à droite dans un élément.</span><span class="sxs-lookup"><span data-stu-id="8aff3-443">Leading or trailing within an element.</span></span>
* <span data-ttu-id="8aff3-444">De début ou de fin dans un `RenderFragment` paramètre.</span><span class="sxs-lookup"><span data-stu-id="8aff3-444">Leading or trailing within a `RenderFragment` parameter.</span></span> <span data-ttu-id="8aff3-445">Par exemple, le contenu enfant est passé à un autre composant.</span><span class="sxs-lookup"><span data-stu-id="8aff3-445">For example, child content passed to another component.</span></span>
* <span data-ttu-id="8aff3-446">Il précède ou suit un bloc de code C#, tel que `@if` ou `@foreach` .</span><span class="sxs-lookup"><span data-stu-id="8aff3-446">It precedes or follows a C# code block, such as `@if` or `@foreach`.</span></span>

<span data-ttu-id="8aff3-447">La suppression des espaces blancs peut affecter la sortie rendue lors de l’utilisation d’une règle CSS, telle que `white-space: pre` .</span><span class="sxs-lookup"><span data-stu-id="8aff3-447">Whitespace removal might affect the rendered output when using a CSS rule, such as `white-space: pre`.</span></span> <span data-ttu-id="8aff3-448">Pour désactiver cette optimisation des performances et conserver l’espace blanc, effectuez l’une des actions suivantes :</span><span class="sxs-lookup"><span data-stu-id="8aff3-448">To disable this performance optimization and preserve the whitespace, take one of the following actions:</span></span>

* <span data-ttu-id="8aff3-449">Ajoutez la `@preservewhitespace true` directive en haut du `.razor` fichier pour appliquer la préférence à un composant spécifique.</span><span class="sxs-lookup"><span data-stu-id="8aff3-449">Add the `@preservewhitespace true` directive at the top of the `.razor` file to apply the preference to a specific component.</span></span>
* <span data-ttu-id="8aff3-450">Ajoutez la `@preservewhitespace true` directive à l’intérieur d’un `_Imports.razor` fichier pour appliquer la préférence à un sous-répertoire entier ou à l’ensemble du projet.</span><span class="sxs-lookup"><span data-stu-id="8aff3-450">Add the `@preservewhitespace true` directive inside an `_Imports.razor` file to apply the preference to an entire subdirectory or the entire project.</span></span>

<span data-ttu-id="8aff3-451">Dans la plupart des cas, aucune action n’est requise, car les applications continuent généralement de se comporter normalement (mais plus rapidement).</span><span class="sxs-lookup"><span data-stu-id="8aff3-451">In most cases, no action is required, as apps typically continue to behave normally (but faster).</span></span> <span data-ttu-id="8aff3-452">Si la suppression d’espace blanc provoque un problème pour un composant particulier, utilisez `@preservewhitespace true` dans ce composant pour désactiver cette optimisation.</span><span class="sxs-lookup"><span data-stu-id="8aff3-452">If stripping whitespace causes any problem for a particular component, use `@preservewhitespace true` in that component to disable this optimization.</span></span>

::: moniker-end

::: moniker range="< aspnetcore-5.0"

<span data-ttu-id="8aff3-453">Les espaces blancs sont conservés dans le code source d’un composant.</span><span class="sxs-lookup"><span data-stu-id="8aff3-453">Whitespace is retained in a component's source code.</span></span> <span data-ttu-id="8aff3-454">Espace blanc : le texte est rendu uniquement dans le Document Object Model du navigateur (DOM), même s’il n’y a aucun effet visuel.</span><span class="sxs-lookup"><span data-stu-id="8aff3-454">Whitespace-only text renders in the browser's Document Object Model (DOM) even when there's no visual effect.</span></span>

<span data-ttu-id="8aff3-455">Prenons le Razor Code du composant suivant :</span><span class="sxs-lookup"><span data-stu-id="8aff3-455">Consider the following Razor component code:</span></span>
...
<span data-ttu-id="8aff3-456">L’exemple précédent restitue l’espace blanc suivant inutile :</span><span class="sxs-lookup"><span data-stu-id="8aff3-456">The preceding example renders the following unnecessary whitespace:</span></span>

* <span data-ttu-id="8aff3-457">En dehors du `@foreach` bloc de code.</span><span class="sxs-lookup"><span data-stu-id="8aff3-457">Outside of the `@foreach` code block.</span></span>
* <span data-ttu-id="8aff3-458">Autour de l' `<li>` élément.</span><span class="sxs-lookup"><span data-stu-id="8aff3-458">Around the `<li>` element.</span></span>
* <span data-ttu-id="8aff3-459">Autour de la `@item.Text` sortie.</span><span class="sxs-lookup"><span data-stu-id="8aff3-459">Around the `@item.Text` output.</span></span>

<span data-ttu-id="8aff3-460">Une liste contenant 100 éléments donne lieu à 402 zones d’espace blanc, et aucun espace blanc supplémentaire n’affecte visuellement la sortie rendue.</span><span class="sxs-lookup"><span data-stu-id="8aff3-460">A list containing 100 items results in 402 areas of whitespace, and none of the extra whitespace visually affects the rendered output.</span></span>

<span data-ttu-id="8aff3-461">Lors du rendu de code HTML statique pour les composants, les espaces à l’intérieur d’une balise ne sont pas conservés.</span><span class="sxs-lookup"><span data-stu-id="8aff3-461">When rendering static HTML for components, whitespace inside a tag isn't preserved.</span></span> <span data-ttu-id="8aff3-462">Par exemple, affichez la source du composant suivant dans le rendu de sortie :</span><span class="sxs-lookup"><span data-stu-id="8aff3-462">For example, view the source of the following component in rendered output:</span></span>

```razor
<img     alt="My image"   src="img.png"     />
```

<span data-ttu-id="8aff3-463">Les espaces blancs ne sont pas conservés dans le Razor balisage précédent :</span><span class="sxs-lookup"><span data-stu-id="8aff3-463">Whitespace isn't preserved from the preceding Razor markup:</span></span>
...
## <a name="additional-resources"></a><span data-ttu-id="8aff3-464">Ressources supplémentaires</span><span class="sxs-lookup"><span data-stu-id="8aff3-464">Additional resources</span></span>

* <span data-ttu-id="8aff3-465"><xref:blazor/security/server/threat-mitigation>: Fournit des conseils sur la création d' Blazor Server applications qui doivent être en concurrence avec l’épuisement des ressources.</span><span class="sxs-lookup"><span data-stu-id="8aff3-465"><xref:blazor/security/server/threat-mitigation>: Includes guidance on building Blazor Server apps that must contend with resource exhaustion.</span></span>
