...
---
# <a name="use-graph-api-with-aspnet-core-no-locblazor-webassembly"></a><span data-ttu-id="41361-103">Utilisez API Graph avec ASP.NET Core :::no-loc(Blazor WebAssembly):::</span><span class="sxs-lookup"><span data-stu-id="41361-103">Use Graph API with ASP.NET Core :::no-loc(Blazor WebAssembly):::</span></span>
...
<span data-ttu-id="41361-105">[Microsoft Graph API](/graph/use-the-api) est une API Web RESTful qui permet :::no-loc(Blazor)::: à et d’autres applications .NET Framework d’accéder aux ressources de service Microsoft Cloud.</span><span class="sxs-lookup"><span data-stu-id="41361-105">[Microsoft Graph API](/graph/use-the-api) is a RESTful web API that enables :::no-loc(Blazor)::: and other .NET Framework apps to access Microsoft Cloud service resources.</span></span>
...
* <span data-ttu-id="41361-113">Ajoutez la `GraphClientExtensions.cs` classe suivante à l’application autonome ou à l' *`Client`* application d’une solution hébergée :::no-loc(Blazor)::: .</span><span class="sxs-lookup"><span data-stu-id="41361-113">Add the following `GraphClientExtensions.cs` class to the standalone app or *`Client`* app of a hosted :::no-loc(Blazor)::: solution.</span></span>
...
<span data-ttu-id="41361-146">Dans un :::no-loc(Razor)::: composant :</span><span class="sxs-lookup"><span data-stu-id="41361-146">In a :::no-loc(Razor)::: component:</span></span>
