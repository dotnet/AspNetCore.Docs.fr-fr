...
* <span data-ttu-id="1c7dc-484">Créer une :::no-loc(Razor)::: application pages nommée « ContactManager »</span><span class="sxs-lookup"><span data-stu-id="1c7dc-484">Create a :::no-loc(Razor)::: Pages app named "ContactManager"</span></span>
