...
* <span data-ttu-id="78318-134">:::no-loc(ASP.NET Core Identity)::: requiert une revendication d' **ID de nom** .</span><span class="sxs-lookup"><span data-stu-id="78318-134">:::no-loc(ASP.NET Core Identity)::: requires a **Name ID** claim.</span></span> <span data-ttu-id="78318-135">Ajoutez-en une à partir de la boîte de dialogue **modifier les règles de revendication** :</span><span class="sxs-lookup"><span data-stu-id="78318-135">Add one from the **Edit Claim Rules** dialog:</span></span>
...
## <a name="use-ws-federation-without-no-locaspnet-core-identity"></a><span data-ttu-id="78318-158">Utilisez WS-Federation sans :::no-loc(ASP.NET Core Identity):::</span><span class="sxs-lookup"><span data-stu-id="78318-158">Use WS-Federation without :::no-loc(ASP.NET Core Identity):::</span></span>

<span data-ttu-id="78318-159">L’intergiciel WS-Federation peut être utilisé sans :::no-loc(Identity)::: .</span><span class="sxs-lookup"><span data-stu-id="78318-159">The WS-Federation middleware can be used without :::no-loc(Identity):::.</span></span> <span data-ttu-id="78318-160">Exemple :</span><span class="sxs-lookup"><span data-stu-id="78318-160">For example:</span></span>
...
## <a name="add-ws-federation-as-an-external-login-provider-for-no-locaspnet-core-identity"></a><span data-ttu-id="78318-161">Ajouter WS-Federation en tant que fournisseur de connexion externe pour :::no-loc(ASP.NET Core Identity):::</span><span class="sxs-lookup"><span data-stu-id="78318-161">Add WS-Federation as an external login provider for :::no-loc(ASP.NET Core Identity):::</span></span>
