...
* <span data-ttu-id="8b89a-206">Dans l’ **Explorateur de solutions** , cliquez avec le bouton droit sur le projet.</span><span class="sxs-lookup"><span data-stu-id="8b89a-206">In **Solution Explorer** , right-click the project.</span></span> <span data-ttu-id="8b89a-207">Sélectionnez **Ajouter**  >  **un nouveau dossier**.</span><span class="sxs-lookup"><span data-stu-id="8b89a-207">Select **Add** > **New Folder**.</span></span> <span data-ttu-id="8b89a-208">Nommez le dossier *Models* .</span><span class="sxs-lookup"><span data-stu-id="8b89a-208">Name the folder *Models*.</span></span>

* <span data-ttu-id="8b89a-209">Cliquez avec le bouton droit sur le *Models* dossier et sélectionnez **Ajouter** une  >  **classe**.</span><span class="sxs-lookup"><span data-stu-id="8b89a-209">Right-click the *Models* folder and select **Add** > **Class**.</span></span> <span data-ttu-id="8b89a-210">Nommez la classe *TodoItem* et sélectionnez sur **Ajouter**.</span><span class="sxs-lookup"><span data-stu-id="8b89a-210">Name the class *TodoItem* and select **Add**.</span></span>
...
* <span data-ttu-id="8b89a-213">Ajoutez un dossier nommé *Models* .</span><span class="sxs-lookup"><span data-stu-id="8b89a-213">Add a folder named *Models*.</span></span>

* <span data-ttu-id="8b89a-214">Ajoutez une `TodoItem` classe au dossier à l' *Models* aide du code suivant :</span><span class="sxs-lookup"><span data-stu-id="8b89a-214">Add a `TodoItem` class to the *Models* folder with the following code:</span></span>
...
* <span data-ttu-id="8b89a-216">Cliquez avec le bouton droit sur le projet.</span><span class="sxs-lookup"><span data-stu-id="8b89a-216">Right-click the project.</span></span> <span data-ttu-id="8b89a-217">Sélectionnez **Ajouter**  >  **un nouveau dossier**.</span><span class="sxs-lookup"><span data-stu-id="8b89a-217">Select **Add** > **New Folder**.</span></span> <span data-ttu-id="8b89a-218">Nommez le dossier *Models* .</span><span class="sxs-lookup"><span data-stu-id="8b89a-218">Name the folder *Models*.</span></span>

  ![nouveau dossier](first-web-api-mac/_static/folder.png)

* <span data-ttu-id="8b89a-220">Cliquez avec le bouton droit sur le *Models* dossier, puis sélectionnez **Ajouter** > **un nouveau fichier** > **General** > **classe générale vide**.</span><span class="sxs-lookup"><span data-stu-id="8b89a-220">Right-click the *Models* folder, and select **Add** > **New File** > **General** > **Empty Class**.</span></span>
...
<span data-ttu-id="8b89a-224">Les classes de modèle peuvent se trouver n’importe où dans le projet, mais le *Models* dossier est utilisé par Convention.</span><span class="sxs-lookup"><span data-stu-id="8b89a-224">Model classes can go anywhere in the project, but the *Models* folder is used by convention.</span></span>
...
* <span data-ttu-id="8b89a-239">Cliquez avec le bouton droit sur le *Models* dossier et sélectionnez **Ajouter** une  >  **classe**.</span><span class="sxs-lookup"><span data-stu-id="8b89a-239">Right-click the *Models* folder and select **Add** > **Class**.</span></span> <span data-ttu-id="8b89a-240">Nommez la classe *TodoContext* et cliquez sur **Ajouter**.</span><span class="sxs-lookup"><span data-stu-id="8b89a-240">Name the class *TodoContext* and click **Add**.</span></span>
...
* <span data-ttu-id="8b89a-242">Ajoutez une `TodoContext` classe au *Models* dossier.</span><span class="sxs-lookup"><span data-stu-id="8b89a-242">Add a `TodoContext` class to the *Models* folder.</span></span>
...
* <span data-ttu-id="8b89a-258">Dans la boîte de dialogue **Contrôleur d’API avec actions, utilisant Entity Framework**  :</span><span class="sxs-lookup"><span data-stu-id="8b89a-258">In the **Add API Controller with actions, using Entity Framework** dialog:</span></span>
  ...
  * <span data-ttu-id="8b89a-259">Sélectionnez **TodoItem (TodoApi. Models )** dans la **classe de modèle**.</span><span class="sxs-lookup"><span data-stu-id="8b89a-259">Select **TodoItem (TodoApi.Models)** in the **Model class**.</span></span>
  * <span data-ttu-id="8b89a-260">Sélectionnez **TodoContext (TodoApi. Models )** dans la **classe de contexte de données**.</span><span class="sxs-lookup"><span data-stu-id="8b89a-260">Select **TodoContext (TodoApi.Models)** in the **Data context class**.</span></span>
...
* <span data-ttu-id="8b89a-487">Dans l’ **Explorateur de solutions** , cliquez avec le bouton droit sur le projet.</span><span class="sxs-lookup"><span data-stu-id="8b89a-487">In **Solution Explorer** , right-click the project.</span></span> <span data-ttu-id="8b89a-488">Sélectionnez **Ajouter**  >  **un nouveau dossier**.</span><span class="sxs-lookup"><span data-stu-id="8b89a-488">Select **Add** > **New Folder**.</span></span> <span data-ttu-id="8b89a-489">Nommez le dossier *Models* .</span><span class="sxs-lookup"><span data-stu-id="8b89a-489">Name the folder *Models*.</span></span>

* <span data-ttu-id="8b89a-490">Cliquez avec le bouton droit sur le *Models* dossier et sélectionnez **Ajouter** une  >  **classe**.</span><span class="sxs-lookup"><span data-stu-id="8b89a-490">Right-click the *Models* folder and select **Add** > **Class**.</span></span> <span data-ttu-id="8b89a-491">Nommez la classe *TodoItem* et sélectionnez sur **Ajouter**.</span><span class="sxs-lookup"><span data-stu-id="8b89a-491">Name the class *TodoItem* and select **Add**.</span></span>
...
* <span data-ttu-id="8b89a-494">Ajoutez un dossier nommé *Models* .</span><span class="sxs-lookup"><span data-stu-id="8b89a-494">Add a folder named *Models*.</span></span>

* <span data-ttu-id="8b89a-495">Ajoutez une `TodoItem` classe au dossier à l' *Models* aide du code suivant :</span><span class="sxs-lookup"><span data-stu-id="8b89a-495">Add a `TodoItem` class to the *Models* folder with the following code:</span></span>
...
* <span data-ttu-id="8b89a-497">Cliquez avec le bouton droit sur le projet.</span><span class="sxs-lookup"><span data-stu-id="8b89a-497">Right-click the project.</span></span> <span data-ttu-id="8b89a-498">Sélectionnez **Ajouter**  >  **un nouveau dossier**.</span><span class="sxs-lookup"><span data-stu-id="8b89a-498">Select **Add** > **New Folder**.</span></span> <span data-ttu-id="8b89a-499">Nommez le dossier *Models* .</span><span class="sxs-lookup"><span data-stu-id="8b89a-499">Name the folder *Models*.</span></span>

  ![nouveau dossier](first-web-api-mac/_static/folder.png)

* <span data-ttu-id="8b89a-501">Cliquez avec le bouton droit sur le *Models* dossier, puis sélectionnez **Ajouter** > **un nouveau fichier** > **General** > **classe générale vide**.</span><span class="sxs-lookup"><span data-stu-id="8b89a-501">Right-click the *Models* folder, and select **Add** > **New File** > **General** > **Empty Class**.</span></span>
...
<span data-ttu-id="8b89a-505">Les classes de modèle peuvent se trouver n’importe où dans le projet, mais le *Models* dossier est utilisé par Convention.</span><span class="sxs-lookup"><span data-stu-id="8b89a-505">Model classes can go anywhere in the project, but the *Models* folder is used by convention.</span></span>
...
* <span data-ttu-id="8b89a-518">Cliquez avec le bouton droit sur le *Models* dossier et sélectionnez **Ajouter** une  >  **classe**.</span><span class="sxs-lookup"><span data-stu-id="8b89a-518">Right-click the *Models* folder and select **Add** > **Class**.</span></span> <span data-ttu-id="8b89a-519">Nommez la classe *TodoContext* et cliquez sur **Ajouter**.</span><span class="sxs-lookup"><span data-stu-id="8b89a-519">Name the class *TodoContext* and click **Add**.</span></span>
...
* <span data-ttu-id="8b89a-521">Ajoutez une `TodoContext` classe au *Models* dossier.</span><span class="sxs-lookup"><span data-stu-id="8b89a-521">Add a `TodoContext` class to the *Models* folder.</span></span>
...
* <span data-ttu-id="8b89a-536">Dans la boîte de dialogue **Contrôleur d’API avec actions, utilisant Entity Framework**  :</span><span class="sxs-lookup"><span data-stu-id="8b89a-536">In the **Add API Controller with actions, using Entity Framework** dialog:</span></span>
  ...
  * <span data-ttu-id="8b89a-537">Sélectionnez **TodoItem (TodoApi. Models )** dans la **classe de modèle**.</span><span class="sxs-lookup"><span data-stu-id="8b89a-537">Select **TodoItem (TodoApi.Models)** in the **Model class**.</span></span>
  * <span data-ttu-id="8b89a-538">Sélectionnez **TodoContext (TodoApi. Models )** dans la **classe de contexte de données**.</span><span class="sxs-lookup"><span data-stu-id="8b89a-538">Select **TodoContext (TodoApi.Models)** in the **Data context class**.</span></span>
...
* <span data-ttu-id="8b89a-773">Ajoutez un dossier nommé *Models* .</span><span class="sxs-lookup"><span data-stu-id="8b89a-773">Add a folder named *Models*.</span></span>

* <span data-ttu-id="8b89a-774">Ajoutez une `TodoItem` classe au dossier à l' *Models* aide du code suivant :</span><span class="sxs-lookup"><span data-stu-id="8b89a-774">Add a `TodoItem` class to the *Models* folder with the following code:</span></span>
...
* <span data-ttu-id="8b89a-776">Cliquez avec le bouton droit sur le projet.</span><span class="sxs-lookup"><span data-stu-id="8b89a-776">Right-click the project.</span></span> <span data-ttu-id="8b89a-777">Sélectionnez **Ajouter**  >  **un nouveau dossier**.</span><span class="sxs-lookup"><span data-stu-id="8b89a-777">Select **Add** > **New Folder**.</span></span> <span data-ttu-id="8b89a-778">Nommez le dossier *Models* .</span><span class="sxs-lookup"><span data-stu-id="8b89a-778">Name the folder *Models*.</span></span>

  ![nouveau dossier](first-web-api-mac/_static/folder.png)

* <span data-ttu-id="8b89a-780">Cliquez avec le bouton droit sur le *Models* dossier, puis sélectionnez **Ajouter** > **un nouveau fichier** > **General** > **classe générale vide**.</span><span class="sxs-lookup"><span data-stu-id="8b89a-780">Right-click the *Models* folder, and select **Add** > **New File** > **General** > **Empty Class**.</span></span>
...
<span data-ttu-id="8b89a-784">Les classes de modèle peuvent se trouver n’importe où dans le projet, mais le *Models* dossier est utilisé par Convention.</span><span class="sxs-lookup"><span data-stu-id="8b89a-784">Model classes can go anywhere in the project, but the *Models* folder is used by convention.</span></span>
...
* <span data-ttu-id="8b89a-789">Cliquez avec le bouton droit sur le *Models* dossier et sélectionnez **Ajouter** une  >  **classe**.</span><span class="sxs-lookup"><span data-stu-id="8b89a-789">Right-click the *Models* folder and select **Add** > **Class**.</span></span> <span data-ttu-id="8b89a-790">Nommez la classe *TodoContext* et cliquez sur **Ajouter**.</span><span class="sxs-lookup"><span data-stu-id="8b89a-790">Name the class *TodoContext* and click **Add**.</span></span>
...
* <span data-ttu-id="8b89a-792">Ajoutez une `TodoContext` classe au *Models* dossier.</span><span class="sxs-lookup"><span data-stu-id="8b89a-792">Add a `TodoContext` class to the *Models* folder.</span></span>
