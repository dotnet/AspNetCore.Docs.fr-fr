...
---
# <a name="build-a-no-locblazor-todo-list-app"></a><span data-ttu-id="6db50-103">Créer une Blazor application de liste de tâches</span><span class="sxs-lookup"><span data-stu-id="6db50-103">Build a Blazor todo list app</span></span>
...
<span data-ttu-id="6db50-105">Ce didacticiel vous montre comment créer et modifier une Blazor application.</span><span class="sxs-lookup"><span data-stu-id="6db50-105">This tutorial shows you how to build and modify a Blazor app.</span></span> <span data-ttu-id="6db50-106">Vous allez apprendre à effectuer les actions suivantes :</span><span class="sxs-lookup"><span data-stu-id="6db50-106">You learn how to:</span></span>

> [!div class="checklist"]
> * <span data-ttu-id="6db50-107">Créer un projet d’application de liste de tâches Blazor</span><span class="sxs-lookup"><span data-stu-id="6db50-107">Create a todo list Blazor app project</span></span>
> * <span data-ttu-id="6db50-108">Modifier les Razor composants</span><span class="sxs-lookup"><span data-stu-id="6db50-108">Modify Razor components</span></span>
...
> * <span data-ttu-id="6db50-110">Utiliser le routage dans une Blazor application</span><span class="sxs-lookup"><span data-stu-id="6db50-110">Use routing in a Blazor app</span></span>
...
## <a name="create-a-todo-list-no-locblazor-app"></a><span data-ttu-id="6db50-113">Créer une application de liste de tâches Blazor</span><span class="sxs-lookup"><span data-stu-id="6db50-113">Create a todo list Blazor app</span></span>

1. <span data-ttu-id="6db50-114">Créez une Blazor application nommée `TodoList` dans une interface de commande :</span><span class="sxs-lookup"><span data-stu-id="6db50-114">Create a new Blazor app named `TodoList` in a command shell:</span></span>
...
1. <span data-ttu-id="6db50-118">Ajoutez un nouveau `Todo` Razor composant à l’application dans le `Pages` dossier à l’aide de la commande suivante :</span><span class="sxs-lookup"><span data-stu-id="6db50-118">Add a new `Todo` Razor component to the app in the `Pages` folder using the following command:</span></span>
...
> [!div class="checklist"]
> * <span data-ttu-id="6db50-159">Créer un projet d’application de liste de tâches Blazor</span><span class="sxs-lookup"><span data-stu-id="6db50-159">Create a todo list Blazor app project</span></span>
> * <span data-ttu-id="6db50-160">Modifier les Razor composants</span><span class="sxs-lookup"><span data-stu-id="6db50-160">Modify Razor components</span></span>
...
> * <span data-ttu-id="6db50-162">Utiliser le routage dans une Blazor application</span><span class="sxs-lookup"><span data-stu-id="6db50-162">Use routing in a Blazor app</span></span>

<span data-ttu-id="6db50-163">En savoir plus sur les outils pour ASP.NET Core Blazor :</span><span class="sxs-lookup"><span data-stu-id="6db50-163">Learn about tooling for ASP.NET Core Blazor:</span></span>
