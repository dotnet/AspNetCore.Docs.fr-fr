...
1. L’autorisation est requise avant qu’Azure DevOps puisse accéder à votre référentiel GitHub. Entrez *<GitHub_username> connexion GitHub* dans la zone de texte nom de la **connexion** . Exemple :
